...
<div id="optional" class="cv-title" markdown="1">

<h1 class="huge" style="width: 100%;">curriculum vitae</h1>

</div>

<div id="resume" class="header" markdown="1">
...
<div class="pub_2" id="pub" markdown="1">      
    <div class="cv_left_two">            
        ...
        <div class="pub_title">
            Modified dynamic mixed subgrid-scale models for forced two-dimensional and beta-plane...
        </div>
    </div>
    <div class="cv_right_two">            
        <span class="pub_journal">
...
<div class="pub_4" id="pub" markdown="1">      
    <div class="cv_left_two">            
        ...
        <div class="pub_title">
            <a href="https://mseas.mit.edu/?p=7043" target="_blank">Multiscale delay neural operators for fluid and ocean flows</a>
        </div>
    </div>
    <div class="cv_right_two">            
        <span class="pub_journal">
...
<div class="pub_6" id="pub" markdown="1">      
    <div class="cv_left_two">            
        ...
        <div class="pub_title">
            <a href="https://ui.adsabs.harvard.edu/abs/2023AGUFM.H31C..02T/abstract" target="_blank">Medium-range weather forecast using Predictive Recurrent Neural Networks</a>
        </div>
    </div>
    <div class="cv_right_two">            
        <span class="pub_journal">
            AGU Fall Meeting <br>Abstracts
        </span>
        <span class="pub_year">
            2023
        </span>
...
<div class="pub_8" id="pub" markdown="1">      
    <div class="cv_left_two">            
        ...
        <div class="pub_title">
            <a href="https://ui.adsabs.harvard.edu/abs/2022APS..APRD08005S/abstract" target="_blank">An Inexpensive Polyvinyltoulene Barrel PET Scanner Design</a>
        </div>
    </div>
    <div class="cv_right_two">            
        <span class="pub_journal">
...
<div class="pub_9" id="pub" markdown="1">      
    <div class="cv_left_two">            
        <div class="pub_auth">
            W Matava, K Klein, F Abouzahr, C Layden, A Sadam, J Cesar, S Park, T Do...
        </div>
        <div class="pub_title">
            <a href="https://ui.adsabs.harvard.edu/abs/2022APS..APRD08004M/abstract" target="_blank">Cost-Effective Depth-Encoding Methods for Time-of-Flight PET Scanners</a>
        </div>
    </div>
    <div class="cv_right_two">            
        <span class="pub_journal">
...
<div class="pub_10" id="pub" markdown="1">      
    <div class="cv_left_two">            
        <div class="pub_auth">
            M Dwyer, D Shoemaker, A Sadam, J Markert
        </div>
        <div class="pub_title">
            <a href="https://ui.adsabs.harvard.edu/abs/2022APS..MARK31001D/abstract" target="_blank">Measurement of Phonon Angular Momentum via the Einstein-de Haas Effect, Fiber-Optic...</a>
        </div>
    </div>
    <div class="cv_right_two">            
        <span class="pub_journal">
            APS March Meeting <br>Abstracts
        </span>
        <span class="pub_year">
            2022
        </span>
