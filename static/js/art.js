...
import 'https://unpkg.com/@appnest/masonry-layout/umd/masonry-layout.min.js';
...
function getContainer() {
  ...
  pswpContainer.style.background = 'rgba(0,0,0,0)';
  pswpContainer.style['backdrop-filter'] = 'blur(40px)';
  pswpContainer.style.width = screen.width;
  pswpContainer.style.height = screen.height;
  pswpContainer.style.display = 'none';
